...
<section class="section">
  <div class="columns">
    ...
    <div class="column is-one-third">
      <div class="content" id="content" style="width: 300px;">
          <div id="form2">
            <h2>Sign Up Here</h2>
            <div>
               <iframe src="//giphy.com/embed/3oz8xSjBmD1ZyELqW4" width="300" height="220" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p></p>
             </div>
              <form action="" method="post">
                        ...
                        <div class="field">
                          ...
                          <p class="control">
                            <span class="select">
                              <select style="width: 300px;" name="u_country" id="country_dropdown_box" style="width: auto;">
                        ...
                        <div class="field">
                          ...
                          <p class="control">
                            <span class="select">
                              <select style="width: 300px;" name="u_gender" >
                          ...
                          <div class="field">
                            ...
                            <p class="control">
                              <span class="select">
                                <input style="width: 300px; height:35px" type="date" name="u_birthday"/>
                                </select>
                              </span>
                            </p>
                            </div>
