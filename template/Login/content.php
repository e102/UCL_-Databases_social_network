...
<div id="content">
    ...
    <div id="form2">
        <h2>Sign Up Here</h2>
        <div>
            <iframe src="//giphy.com/embed/3oz8xSjBmD1ZyELqW4" width="240" height="180" frameBorder="0"
        ...
        <form action="" method="post">
            ...
            <div class="field"><label class="label">Name</label>
                <p
                        class="control"><input class="input" type="text" name="u_name" placeholder="Enter your name"
            ...
            <div class="field"><label class="label">Email</label>
                <p class="control has-icon"><input class="input" type="email" name="u_email"
